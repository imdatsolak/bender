...
Usage:
    convert_csv.py -i <input-csv-file> -o <output-directory>

Created: 2017-06-08 09:00 CET, Imdat Solak

RULES:
    - The CSV-File *must* be tab-delimited.
    - The CSV-file *must* be UTF-8
    - The first column *must* be the title column
...
try:
    ...
    print('Usage:')
    print('\tpython convert_csv.py -i <inputfile> -o <outputdir> [-h]')
    print()
...
if inputfile == None or outputdir == None:
    print('Usage: convert_csv.py -i <inputfile> -o <outputdir>')
    sys.exit(1)
